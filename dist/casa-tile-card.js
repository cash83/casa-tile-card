...
:host([ytm]) .nome { font-size: 10px; letter-spacing: .08em; opacity: .75; }
:host([ytm]) .sotto .brano { font-size: 20px; line-height: 1.15; -webkit-line-clamp: 1;
  text-align: left; }
:host([ytm]) .sotto .artista { font-size: 13px; text-align: left; }
