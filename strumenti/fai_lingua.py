...
ETI = {
    ...
    'tieni_premuto': 'What happens when you hold it down',
...
# ---------------------------------------- i tre editor dei consumi
# Le schede casa-energia e casa-elettrodomestico e i loro editor: le
# scritte stanno nei file elettro-*, non nello schema della casella,
...
ELETTRO = {
    ...
    # titoli di sezione e paragrafi di aiuto
...
# ---------------------------------- le due schede dei consumi
# Le righe, le finestrelle e gli avvisi di casa-energia e
# casa-elettrodomestico. I giorni e i mesi NON stanno qui: li scrive il
...
for it, en in ELETTRO.items():
    coppie.append((it, en))

for it, en in ELETTRO_SCHEDE.items():
    coppie.append((it, en))
